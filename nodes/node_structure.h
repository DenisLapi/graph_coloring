...
* nodes starting from the nodes with a bigger number of connections.
*/
typedef struct node_struct {
    int id;  /**< ID - unique for every node. We are using this value to select the row in the <b>graph matrix</b> \warning ID represend one row in the graph matrix */
